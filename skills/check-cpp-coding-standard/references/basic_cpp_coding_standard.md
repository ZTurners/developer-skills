...
1. Check the basic coding standards file in {SKILL_FOLDER}/references/basic_cpp_coding_standard.md for general guidelines on C++ coding standards. This file should provide a comprehensive overview of the best practices and common pitfalls in C++ programming.
