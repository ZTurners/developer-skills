---
description: "Use for C++ files in source/. Defines ArieoEngine C++ coding standards for naming, formatting, ownership, interfaces, and module lifecycle patterns."
applyTo: "source/**/*.{h,hpp,hxx,c,cc,cpp,cxx,inl}"
---
# ArieoEngine C++ Coding Standard
